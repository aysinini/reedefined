...
'footer.rights': '© 2026 Reedefined. All rights reserved.',
  ...
  tr: {
    ...
    'ns.issue_dek': 'Buradaki her makale, gerçekten sevdiği bir şey hakkında gerçek bir kişi tarafından yazıldı. Zevkine güvendiğin contributorları takip et, bir sonraki sayın tamamen onlar tarafından şekillenecek.',
    'ns.stat_contributor': 'Contributor',
    ...
    'ns.empty_articles_sub': 'Takip ettiğin contributorlar yayınladığında, yazıları burada görünecek.',
    'ns.your_issue': 'Senin Sayın',
    'ns.your_issue_empty': 'Henüz makale yok, Discover sayfasından contributor takip et, sayın dolmaya başlasın.',
    'ns.empty_contributors': 'Henüz hiçbir contributor yayınlamadı.',
