const TRANSLATIONS = {
  en: {
    ...
    'ns.contributors_issue_label': 'Contributors — July 2026',
...
'footer.rights': '© 2026 Reedefined. All rights reserved.',
  ...
  tr: {
    ...
    'ns.footer_dek': "Takip ettiğin insanların şekillendirdiği dergi. Kişisel denemeler, playlistler, film incelemeleri, güvendiğin yazarlardan ve zevk sahiplerinden. Her ay, sadece senin için derleniyor.",
    'ns.footer_contributors': 'Yazarlar',
    'ns.contributor_portal': 'Yazar Portalı',
    'ns.connect_platforms': 'Platformları Bağla',
    'ns.footer_about': 'Hakkımızda',
    'ns.footer_signup': 'Kayıt Ol',
    'ns.footer_signin': 'Giriş Yap',
    'ns.contributors_issue_label': 'Yazarlar — Temmuz 2026',
    'ns.contributors_this_issue': 'Bu sayının yazarları',
    'ns.footer_tagline': 'Takip ettiğin insanların şekillendirdiği dergi.',
    // Discover page
    'disc.h1_1': 'Keşfet',
    'disc.h1_2': 'kimi takip edeceğini.',
    'disc.sub': "Reedefined için yazan yazarlara göz at, hayran olduğun zevke sahip kişilerin herkese açık sayılarını gör. Onları takip et, yazıları senin sonraki sayını şekillendirsin.",
    'disc.search_ph': 'Yazar, ilgi alanı, isim ara…',
    'disc.clear': 'Temizle ✕',
    'disc.featured_sub': 'Özenle seçilmiş herkese açık sayılar',
    'disc.public_h': 'Herkese Açık Sayılar',
    'disc.public_sub': 'Ne okuduğunu paylaşan kişiler',
    'disc.no_contrib': 'Eşleşen yazar yok.',
    'disc.no_public': 'Eşleşen herkese açık sayı yok.',
    'disc.try_different': 'Farklı bir filtre ya da arama terimi dene.',
...
'footer.rights': '© 2026 Reedefined. Tüm hakları saklıdır.',
  ...
  de: {
    ...
    'ns.contributors_issue_label': 'Autoren — Juli 2026',
